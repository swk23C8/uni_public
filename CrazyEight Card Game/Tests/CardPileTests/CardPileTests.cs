...
namespace GameObjectsTests {
    ...
    public class A3_CardPileTests {
        ...
        public void TestConstructorBuildsDeckInCorrectOrderViaDealOneCard() {
            // NOTE TO STUDENTS
            // YOUR IMPLEMENTATION SHOULD NOT USE A HARD-CODED LIST LIKE THIS ONE
            // YOUR IMPLEMENTATION SHOULD BE MORE INTELLIGENT ABOUT HOW THE LIST IS CONSTRUCTED
        ...
        public void TestShufflePile() {
            ...
            // selecting a the same atom on Earth twice in a row.
            Assert.Fail();
